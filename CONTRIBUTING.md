...
| `style`        | Realiza mudanças na aparência, sem alterar as funcionalidades.         | `style: add EFFECTNAME to COMPONENT`
| `refactor`     | Realiza mudanças no código que não alteram as funcionalidades.         | `refactor: refactor at CLASSNAME`
